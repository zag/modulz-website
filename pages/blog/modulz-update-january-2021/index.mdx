...
### Inspect Mode
We added the Inspector to better support the typical developer handoff workflow. Click the "Inpsect" tab to see the CSS for the selected component(s). Choose between string or object syntax, then click the copy icon to grab the styles and paste them into your code editor.
