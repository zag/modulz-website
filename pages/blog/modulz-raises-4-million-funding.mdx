...
We arrived on the design tool scene early this year with a [successful Kickstarter campaign](https://www.kickstarter.com/projects/stephenhaney/modulzthe-next-step-in-visual-coding), raising <span children="$" />36k from 394 backers who pre-paid for early access.

Since then, we've raised <span children="$" />4.2M in seed funding from LocalGlobe, Frontline and many high-profile angel investors including Ryan Hoover (Founder of Product Hunt), Vedika Jain (Weekend Fund), Des Traynor (Co-founder of Intercom), Jina Anne (Founder of Clarity), TinyVC and other great investors.
