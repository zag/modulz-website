...
We arrived on the design tool scene early this year with a <a href="https://www.kickstarter.com/projects/stephenhaney/modulzthe-next-step-in-visual-coding" style={{ textDecoration: 'none' }} target="\_blank"><Link as="span" style={{ fontSize: 'inherit' }}>successful Kickstarter campaign</Link></a>, raising \$36k from 394 backers who pre-paid for early access.
