...
<ProductVideo src={yelp}>
  Pressing <Code variant="fade">Up</Code> and <Code variant="fade">Down</Code> arrows don't cycle over the options.
</ProductVideo>
...
This functionality prevents clicks on elements that are outside of the Select component. When you click outside, the Menu will be closed.
