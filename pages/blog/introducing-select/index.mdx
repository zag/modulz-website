...
Keyboard navigation. Typeahead functionality. Collision-aware positioning. Screen reader support. These are some of the most common features that custom Selects tend to lack.
...
**Typeahead:** typing in "US Dollar" doesn't skip to that option.
...
**Collision detection:** the Menu is being cropped by the viewport.
...
**Managing expectations:** the Menu is not positioned relative to the click target.
