...
Every Select designed with Modulz works with screen readers. One less thing thing for you to worry about.
...
You may prefer to rely on the native implementation in certain situations. This is possible by passing a `isNative` prop to the Select component.
