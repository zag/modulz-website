...
The Select component has many parts. In Modulz, you can style each one and their respective states.

<ProductImage src={parts}>All the parts of a Select component.</ProductImage>
