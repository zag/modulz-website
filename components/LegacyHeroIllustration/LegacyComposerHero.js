...
import { Section, Container, Flexbox, Box, Text, Heading, AspectRatio, LinesButton, Theme } from 'radix-ds';
import ComposerScreen from './ComposerScreen';
import HomepageHero from '../../public/home/homepage-hero-min.png';

const OMGFucksSake = styled.div`
  display: none;

  @media only screen and (min-width: ${Theme.BREAKPOINT_200}) {
    display: block;
  }
`;
      ...
      <Box mt_8 mb_8>
        <Container size2>
          <Flexbox fd_column bp1_fd_row>
            <Flexbox fg_1 fb_0 ai_flexend fd_column>
              <Box mb_9>
            ...
            <Box fg_1 fb_0>
              <Flexbox height_100 ai_center jc_center>
                <Box
                  position_relative
                  style={{
                    boxShadow:
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="72" height="65" viewBox="0 0 72 65" fill="none">
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M14.5471 23.178L35.9145 65L0 23.178H14.5471Z"
                    fill="#EA6C00"
                  />
                  <path
                    fill-rule="evenodd"
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M0 23.1781L15.6717 2.14014L14.5471 23.1781H0Z"
                    fill="#FDAD00"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M35.9144 0L14.5471 23.178H57.2818L35.9144 0Z"
                    fill="#FEEEB7"
                  />
                </svg>
              </Box>
